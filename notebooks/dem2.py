...
class HannahKontarModel(IDLModel):
    ...
    def _template(self,):
        ...
        ; Do inversion
        {% if alpha_regularization is defined %}
        reg_tweak={{alpha_regularization}}
        {% else %}
        reg_tweak=1
        {% endif %}
        dn2dem_pos_nb,data,data_errors,response_matrix,response_logt,temperature,dem,dem_errors,logt_errors,chi_squared,dn_regularized,reg_tweak=reg_tweak"""