...
Similar to the ChiantiPy package, fiasco provides several useful abstractions of the database. The first is the \pyv{Ion} object. To instantiate an \pyv{Ion} object for Fe XVI,
% spell-checker: disable %
\begin{pyblock}[appendix1][baselinestretch=1,xleftmargin=3em]
...
Some quantities such as spectra or radiative loss curves require data from more than one ion and not necessarily of the same element. fiasco provides a general \pyv{IonCollection} object.
