...
\section{A History of Coronal EUV and X-ray Observations}

% fold this into previous section
...
# Fix TRACE metadata
#maps[2] = Map(maps[2].data, {**maps[2].meta, 'wavelnth': maps[2].meta['wave_len']},)
# Fix XRT metadata
maps[2] = Map(maps[2].data, {**maps[2].meta, 'wavelnth': f'{maps[2].meta["ec_fw1_"]}/{maps[2].meta["ec_fw2_"]}'})
...
for i,m in enumerate(maps):
    ...
    try:
        ...
        wvl = m.meta['wavelnth']
    ax.text(0, m.dimensions.y.value-10, f'{name} {wvl}',
            color='w',
            fontsize=plt.rcParams['legend.fontsize'],
            horizontalalignment='left',
            verticalalignment='top',)
    ax.text(m.dimensions.x.value,0,astropy.time.Time(m.date).strftime('%Y/%d/%m'),
            color='w',
            fontsize=plt.rcParams['legend.fontsize'],
...
% mention software here? put it in acknowledgements? could have a very short section about importance of software in this work, importance of open development
