...
The $\dem$ is a useful diagnostic for understanding the temperature distribution of the coronal plasma and, by extension, the underlying energy deposition. However, calculating this quantity from observations is difficult for several reasons.

\subsection{The Emission Measure Slope}

% show example for single nanoflare and high-frequency heating
