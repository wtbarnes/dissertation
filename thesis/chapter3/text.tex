...
For element $X$ with $K$ total charge states, \autoref{eq:ionization_equilibrium} represents a system of $K$ linear, homogeneous equations and can be expressed in matrix form as,
