...
\subsection{Constructing the Virtual Observer}\label{sec:constructing-observer}
...
\subsection{Projecting Along the LOS}\label{sec:projecting-along-los}
