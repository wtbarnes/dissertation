...
The coordinates of each strand are stored as Astropy \pyv{SkyCoord} objects. A \pyv{SkyCoord} stores the numerical value of the coordinate as well as the frame of reference in which the coordinate is defined, making it simple to represent the position of the strands in different coordinate systems.
