...
\begin{align}
    \frac{d}{dt}p_e = \frac{\gamma - 1}{L}(\psi_{TR} - R_C(1 + c_1)) + k_Bn\nu_{ei}(\bar{T}_i - \bar{T}_e) + (\gamma - 1)\bar{Q}_e,\tag{\autoref{eq:press_e_0d_2fl}} \\
    \frac{d}{dt}p_i = -\frac{\gamma - 1}{L}\psi_{TR} + k_Bn\nu_{ei}(\bar{T}_e - \bar{T}_i) + (\gamma - 1)\bar{Q}_i,\tag{\autoref{eq:press_e_0d_2fl} }\\
    \frac{d}{dt}n = -\frac{\xi}{1+\xi}\frac{c_2(\gamma - 1)}{c_3L\gamma k_B\bar{T}_e}(F_{ce,0} + F_{ci,0} + c_1R_C),\tag{\autoref{eq:mass_0d_2fl}}
\end{align}
